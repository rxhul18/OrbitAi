  ...
  ({ className, onInput, onKeyDown, ...props }, ref) => {
    ...
    return (
      <textarea
        ...
        className={cn(
          "flex min-h-[40px] max-h-[80px] w-full rounded-md bg-transparent px-3 py-2 text-sm shadow-sm placeholder:text-muted-foreground resize-none border border-transparent focus-visible:outline-none",
          className,
        )}
        onInput={handleInput}
