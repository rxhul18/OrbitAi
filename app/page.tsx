...
const content = [
  {
    ...
    description:
      "Take notes your way—text, links, images, and more. Brain keeps it all, easy to recall anytime.",
    image: storeNotes,
    commingSoon: false,
  },
  {
    ...
    description:
      "Brain works like your brain and remember things like you remember them.",
    image: sementicImage,
    commingSoon: false,
  },
  {
    ...
    description:
      "Brain understand images. Any images you save are automatically remembered, requiring little to no context to make sense of it.",
    image: imageTagging,
    commingSoon: true,
  },
  {
    ...
    description:
      "We tend to save things and forget. Auto-create reminders on Brain so you don't.",
    image: reminderImage,
    commingSoon: true,
  },
];
      ...
      <main className="border border-dashed border-t-0 bg-background">
        ...
        <section className="border border-dashed border-b-0 relative">
          <div className=" border border-dashed border-y-0 container items-center mx-auto px-4 text-center pt-16 md:py-24 md:pb-10 pb-16 bg-gradient-to-b from-gray-50 dark:from-background from-90% to-[#cdd7e2] dark:to-background to-1%">
            <h2 className="text-4xl md:text-[2.7rem] font-serif mb-3 text-[#334155] dark:text-white font-extralight tracking-tight">
              Works like your brain. Does more.
            </h2>
            {content.map((item, index) => (
              <>
                <div
                  className="flex relative flex-col md:flex-row-reverse select-none rounded-3xl bg-black dark:bg-primary-foreground dark:border dark:shadow-xl dark lg:max-w-[70%] text-white mx-auto my-16"
                  key={index}
                >
                  ...
                  <div className="w-auto px-10 py-10 md:py-16 text-start ">
                    <h2 className="font-serif text-xl font-thin mb-3">
                      {item.title}
                    </h2>
                    ...
                    {item.commingSoon && (
                      <Badge
                        className="absolute bottom-3 right-3 md:bottom-8 md:left-10 w-fit mt-3 text-black"
                        variant={"default"}
                      >
                        Comming soon
                      </Badge>
